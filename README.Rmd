...
This is an example of what type of analysis you can do with `mrf2d`. More features are also present, including estimation of parameter in Markov Random Fields, families of parameter restrictions and more. Read the package's [vignette](https://freguglia.github.io/mrf2d/articles/mrf2d.html) for more information and detailed description of the functions used: `browseVignettes("mrf2d")`.
...
```{r Y_example_plot, echo = TRUE, fig.width=5.5, fig.height=4, fig.align='center'}
set.seed(1)
...
```{r results_plot, echo = TRUE, fig.width=3, fig.height=2.5, fig.show = 'hold'}
fit$par
